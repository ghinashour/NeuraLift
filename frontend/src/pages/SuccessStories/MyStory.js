    ...
    return (
        <div className="my-story">
            <div className="my-story-header">
                <div className="my-story-header-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none" className="my-story-header-icon">
                    ...
                    <h1 className="my-story-header-title">Share Your Success Story</h1>
                </div>
                <p className="my-story-header-text">Inspire others with your journey and achievements.</p>
            </div>
