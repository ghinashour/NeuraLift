...
const Features = () => {
  return (
    <section id="Features" className="features-section h-screen flex items-center justify-center bg-green-100 " style={{ color: "#ffffff" }}>
      <div className="features-container">
        <h1>Everything You Need for Growth</h1>
        ...
        <div className="features-box-container">
          <div className="features-box">
            ...
            <br></br>
            <b className="features-tasks-title">Task Management</b>
            <p className="features-expression">
          ...
          <div className="features-box">
            ...
            <br></br>
            <b className="features-tasks-title">Daily Motivation</b>
            <p className="features-expression">
          ...
          <div className="features-box">
            ...
            <b className="features-tasks-title">Creative Canvas</b>
            <p className="features-expression">
          ...
          <div className="features-box">
            ...
            <br></br>
            <b className="features-tasks-title">Health Tracking</b>
            <p className="features-expression">
